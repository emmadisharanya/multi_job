"""
Single-Job Federated Learning - Complete Script
Run from main directory: python run_single_job_fl.py
"""
import torch
import yaml
...
def create_model(model_name, num_classes=10):
    ...
    elif model_name == 'alexnet':  # ADD THIS
        from models.alexnet import AlexNet
        return AlexNet(num_classes=num_classes, input_channels=1, input_size=28)
    else:
...
def plot_results(history, save_path='results/single_job_fl.png'):
    ...
    # Plot loss
    ax1.plot(rounds, history['train_loss'], label='Train Loss', 
             linewidth=2, marker='o', markersize=3)
    ax1.plot(rounds, history['test_loss'], label='Test Loss', 
    ...
    # Plot accuracy
    ax2.plot(rounds, history['train_accuracy'], label='Train Accuracy', 
             linewidth=2, marker='o', markersize=3)
...
if __name__ == "__main__":
    print("\n" + "=" * 70)
    print("FEDERATED LEARNING - SINGLE JOB EXPERIMENT")
    print("=" * 70)
    ...
    print("=" * 70)
    print("\nResults saved:")
    print("  - Plot: results/single_job_fl.png")
    print("\nTo view the plot:")
    print("  start results\\single_job_fl.png")
    print("=" * 70)